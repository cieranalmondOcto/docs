...
```markdown
## 🧪 Changes made in Mintlify

Test cases

* Check Sync from Mintlify to Github  ✅
* Check approval workflow from within Gitbook, that syncs to Github. Set myself as the approver. 
* Check approval workflow for Mintlify > Github using Slack approval
* Check approval workflow for Mintlify > Github using Email approval 
